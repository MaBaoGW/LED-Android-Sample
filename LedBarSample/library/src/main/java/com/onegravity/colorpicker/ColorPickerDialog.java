...
public class ColorPickerDialog implements OnColorChangedListener, OnTabChangeListener {
        ...
        mDialog = new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        color_changed = true;
                        finalizeChanges(mNewColor,color_changed);
                    }
                })
                .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        color_changed = false;
                        finalizeChanges(mInitialColor,color_changed);
                    }
                })
    ...
    private void finalizeChanges(int color,boolean colorChanged) {
        if (mListener != null) {
            mListener.onColorChanged(color);
            mListener.onDialogClosing(colorChanged);
        }
